...
/**
 * AWS Orange/Gold theme palette and highlight generation.
 * Base color: #FF9900 (AWS Orange)
 */
object AwsTheme:
  ...
  def generateHighlights(): Map[String, HighlightGroup] =
    ...
    // Secondary shades (slightly adjusted orange)
    ...
    highlights("Function") = HighlightGroup(fg = Some("#FFD700"))
