...
/**
 * Azure Blue theme palette and highlight generation.
 * Base color: #0078D4 (Azure Blue)
 */
object AzureTheme:

  val BaseColor = "#0078D4"
  private val ErrorColor = "#FF3333"
  private val WarningColor = "#FFB800"
  private val SuccessColor = "#27AE60"
  private val InfoColor = "#5B9FBD"
  ...
  def generateHighlights(): Map[String, HighlightGroup] =
    ...
    // Secondary shades (adjusted blue)
    ...
    highlights("Function") = HighlightGroup(fg = Some("#87CEEB"))
